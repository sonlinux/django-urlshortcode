...
then
    ...
    rsync -L  backups/latest.dmp staging.urlshort.babylon.com:/home/urlshort-client/deployment/backups/
    rsync -r -v media/ staging.urlshort.babylon.com:/home/urlshort-client/deployment/media
	...
	ssh staging.urlshort.babylon.com "cd /home/urlshort-client/deployment && git fetch --tags && git checkout $VERSION && make collectstatic && make reload"
else
